...
/**
 * A Mock model for Computer Player which isolates the controller.This model
 * class merely logs the inputs provided to it, and returns a unique number
 * provided to it at creation. It tests whether the inputs provided to the
 * controller were correctly transmitted to the model, and the results from the
 * model were correctly transmitted to the Appendable object by the controller.
 */
public class WorldMockModelComputer implements World {
  private StringBuilder log;
  private final int uniqueCode;

  /**
   * Constructor to initialize WorldMockModelComputer class fields.
   * 
   * @param log        log to track
   * @param uniqueCode unique code
   */
  public WorldMockModelComputer(StringBuilder log, int uniqueCode) {
    this.log = log;
